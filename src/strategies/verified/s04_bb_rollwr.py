"""WF+BB%B+BBmom+rollWR noTP: champion (Sharpe 23.51)"""
import numpy as np

from src.evaluation.engine import run_backtest_custom
from src.evaluation.simulation import get_tp_sl_no_tp
from src.signals.filters import bb_pct_ok, compute_bb, compute_bb_momentum, compute_roll_wr
...
def run(data, verbose=True):
    ...
    return run_backtest_custom(sig, "WF+BB%B+BBmom+rollWR noTP", get_tp_sl_no_tp, data, pred_ret_ref=data['pred_ret'], verbose=verbose)
